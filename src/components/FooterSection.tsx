            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-400 text-xs italic">{t('footer.phoneCallOnly')}</p>
                  <a href="tel:+526646341096" className="text-white hover:text-primary transition-colors duration-300 block">
              ...
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-primary mt-1 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                ...
                <div>
                  <p className="text-gray-300 text-sm">{t('footer.whatsappForMessages')}</p>
                  <a
