    ...
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 flex items-center min-h-screen pt-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            <div className="animate-slide-in-left">
              ...
              <div className="bg-cyan-500 text-white px-6 py-3 rounded-lg inline-block text-sm mb-8 animate-fade-in-slow">
            ...
            <div className="relative animate-slide-in-right">
              <img 
                src={heroBg}
                alt="Persona feliz"
                className="w-full h-auto rounded-3xl hover:scale-105 transition-transform duration-500"
              />
            </div>
          </div>
        </div>
      ...
      <section id="problema" className="bg-[image:var(--gradient-dark)] text-white py-20" style={{ background: "var(--gradient-dark)" }}>
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              <p className="text-xl mb-6 animate-fade-in">Si tú:</p>
            ...
            <div className="relative animate-slide-in-right">
              <img 
                ...
                className="w-full h-auto rounded-3xl hover:scale-105 transition-transform duration-500 animate-float"
              />
            </div>
          </div>
      ...
      <section id="solucion" className="bg-[image:var(--gradient-accent)] py-20" style={{ background: "var(--gradient-accent)" }}>
        <div className="container mx-auto px-4">
          ...
          <h3 className="text-3xl font-bold text-center mb-8 animate-fade-in-slow">
            Permanente de Sudor y Olor
          </h3>
          
          <p className="text-center text-lg max-w-3xl mx-auto mb-16 text-gray-700 animate-fade-in-slow">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="animate-slide-in-left">
              <h3 className="text-3xl font-bold mb-8 animate-fade-in">Imagina</h3>
      ...
      <section className="bg-[image:var(--gradient-dark)] text-white py-20" style={{ background: "var(--gradient-dark)" }}>
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-right">
              <h3 className="text-4xl font-bold mb-8 animate-fade-in">
                Con <span className="text-cyan-400">miraDry</span> Láser, obtienes:
              </h3>
              
              <div className="space-y-4 mb-8">
                <div className="bg-yellow-400 text-black px-6 py-4 rounded-lg font-semibold text-lg animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
                  Reducción permanente del sudor
                </div>
                <div className="bg-yellow-400 text-black px-6 py-4 rounded-lg font-semibold text-lg animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.4s', opacity: 0, animationFillMode: 'forwards' }}>
                  Reducción permanente del mal olor
                </div>
              </div>
              
              <p className="text-xl text-cyan-400 animate-fade-in-slow">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-4 gap-4 p-4 bg-gradient-to-r from-cyan-400 to-cyan-300 text-white rounded-lg font-bold text-center animate-bounce-in hover:scale-110 animate-glow transition-transform duration-300" style={{ animationDelay: '0.4s', opacity: 0, animationFillMode: 'forwards' }}>
                <div>miraDry</div>
                <div>Permanente</div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-right">
              ...
              <p className="text-xl mb-6 animate-fade-in">MiraDry es ideal para ti si:</p>
              
              <div className="space-y-4 mb-8">
                <div className="bg-cyan-400 text-black px-6 py-4 rounded-lg font-semibold animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
                  Mojás o manchas de sudor camisas sin importar el clima
                </div>
                <div className="bg-cyan-400 text-black px-6 py-4 rounded-lg font-semibold animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.3s', opacity: 0, animationFillMode: 'forwards' }}>
                  Te limita social o profesionalmente
                </div>
                <div className="bg-cyan-400 text-black px-6 py-4 rounded-lg font-semibold animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '0.4s', opacity: 0, animationFillMode: 'forwards' }}>
                  Prefieres una solución médica, no cosmética
                </div>
              </div>
              
              <div className="bg-yellow-400 text-black px-8 py-6 rounded-xl text-center text-xl font-bold animate-bounce-in hover:scale-110 transition-all duration-300" style={{ animationDelay: '0.5s', opacity: 0, animationFillMode: 'forwards' }}>
      ...
      <section id="contacto" className="bg-[image:var(--gradient-vibrant)] py-20" style={{ background: "var(--gradient-vibrant)" }}>
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl font-bold mb-8 animate-bounce-in">
          ...
          <div className="max-w-2xl mx-auto">
            <p className="text-3xl font-bold mb-6 animate-fade-in">Tu siguiente <span className="italic">paso</span></p>
            ...
            <Button className="bg-yellow-400 hover:bg-yellow-500 text-black text-xl px-12 py-6 rounded-full font-bold animate-bounce-in hover:scale-110 transition-all duration-300" style={{ animationDelay: '0.5s', opacity: 0, animationFillMode: 'forwards' }}>
              Agenda tu Consulta + Prueba de Sudoración
            </Button>
          </div>
        </div>
      ...
      <footer className="bg-black text-white py-12 text-center">
        <div className="container mx-auto px-4">
          <p className="text-2xl font-bold mb-4 animate-fade-in">
            Estás A UNA decisión de transformar tu confianza,<br />
            levantar los brazos sin pensarlo y olvidar el sudor para siempre
          </p>
          
          <Button className="mt-6 bg-cyan-400 hover:bg-cyan-500 text-black text-lg px-8 py-4 rounded-full font-bold animate-bounce-in hover:scale-110 transition-all duration-300">
            Agenda tu Consulta + Prueba de Sudoración
          </Button>
        </div>
      </footer>
